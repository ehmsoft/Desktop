...
class ConnectionManager(object):
    ...
    def __crearBD(self):
        try:
            ...
            c.execute('''CREATE TABLE 'atributosPersona'('id_atributo' INTEGER PRIMARY KEY,'nombre' TEXT,'obligatorio' BOOLEAN,'longitud_max' INTEGER,'longitud_min' INTEGER, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), UNIQUE('nombre','obligatorio'))''')
            #Crear tabla Atributos por demandante, para relacionar los campos personalizados con los demandantes
            c.execute('''CREATE TABLE 'atributos_demandante'('id_atributo_demandante' INTEGER PRIMARY KEY,'id_atributo' INTEGER,'id_demandante' INTEGER,'valor' TEXT, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), FOREIGN KEY(id_atributo) REFERENCES atributosPersona(id_atributo),FOREIGN KEY(id_demandante) REFERENCES demandantes(id_demandante),UNIQUE('id_atributo','id_demandante','valor'))''')
            #Crear tabla Atributos por demandado, para relacionar los campos personalizados con los demandados
            c.execute('''CREATE TABLE 'atributos_demandado'('id_atributo_demandado' INTEGER PRIMARY KEY,'id_atributo' INTEGER,'id_demandado' INTEGER,'valor' TEXT, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), FOREIGN KEY(id_atributo) REFERENCES atributosPersona(id_atributo),FOREIGN KEY(id_demandado) REFERENCES demandados(id_demandado),UNIQUE('id_atributo','id_demandado','valor'))''')
            ...
            c.execute('''CREATE TABLE 'atributosJuzgado'('id_atributo' INTEGER PRIMARY KEY,'nombre' TEXT,'obligatorio' BOOLEAN,'longitud_max' INTEGER,'longitud_min' INTEGER, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), UNIQUE('nombre','obligatorio'))''')
            #Crear tabla Atributos por juzgado, para relacionar los campos personalizados con los juzgados
            c.execute('''CREATE TABLE 'atributos_juzgado'('id_atributo_juzgado' INTEGER PRIMARY KEY,'id_atributo' INTEGER,'id_juzgado' INTEGER,'valor' TEXT, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), FOREIGN KEY(id_atributo) REFERENCES atributosJuzgado(id_atributo),FOREIGN KEY(id_juzgado) REFERENCES juzgados(id_juzgado),UNIQUE('id_atributo','id_juzgado','valor'))''')
            ...
            c.execute('''CREATE TABLE 'atributosActuacion'('id_atributo' INTEGER PRIMARY KEY,'nombre' TEXT,'obligatorio' BOOLEAN,'longitud_max' INTEGER,'longitud_min' INTEGER, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), UNIQUE('nombre','obligatorio'))''')
            #Crear tabla Atributos por actuacion, para relacionar los campos personalizados con los actuaciones
            c.execute('''CREATE TABLE 'atributos_actuacion'('id_atributo_actuacion' INTEGER PRIMARY KEY,'id_atributo' INTEGER,'id_actuacion' INTEGER,'valor' TEXT, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')), FOREIGN KEY(id_atributo) REFERENCES atributosActuacion(id_atributo),FOREIGN KEY(id_actuacion) REFERENCES actuaciones(id_actuacion),UNIQUE('id_atributo','id_actuacion','valor'))''')
            ...
            c.execute('''CREATE TABLE 'archivos_proceso'('id_archivo_proceso' INTEGER PRIMARY KEY, 'id_proceso' INTEGER, 'ruta' TEXT, 'nuevo' BOOLEAN DEFAULT 0, 'modificado' BOOLEAN DEFAULT 0, 'eliminado' BOOLEAN DEFAULT 0, 'fecha_mod' DATE DEFAULT (datetime('now', 'localtime')))''')
