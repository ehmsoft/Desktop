...
class Persistence(object):
    ...
    def borrarPlantilla(self, plantilla):
        try:
            ...
            c.execute('''DELETE FROM plantillas WHERE id_plantilla = ?''', (plantilla.getId_plantilla(),))
            c.execute('''DELETE FROM atributos_plantilla WHERE id_plantilla = ?''', (plantilla.getId_plantilla(),))
            conn.commit()
    ...
    def borrarCampoPlantilla(self, campoPersonalizado):
        try:
            ...
            c.execute('''DELETE FROM atributos_plantilla WHERE id_atributo_plantilla = ?''', (campoPersonalizado.getId_campo(),))
            conn.commit()            
        except Exception as e:
            raise e
        finally:
    ...
    def borrarCitaCalendario(self, cita):
        try:
            ...
            c.execute('''DELETE FROM citas WHERE id_cita = ?''', (cita.getId_cita(),))
            conn.commit()            
        except Exception as e:
            raise e
        finally:
